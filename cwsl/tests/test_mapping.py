...
class TestMapping(unittest.TestCase):
    ...
    def test_filecreator_mapping(self):
        """ Tests that mapping between constraint names works."""
        ...
        self.assertEqual(1, len(non_mapped_file))
        self.assertEqual(1, len(mapped_file))

        self.assertEqual(non_mapped_file[0].full_path,
                         mapped_file[0].full_path)
    ...
    def test_change_mapping(self):
        ...
        with mock.patch('cwsl.core.pattern_dataset.PatternDataSet.glob_fs') as mock_glob:
            ...
            expected_string = (self.script_header +
                               "mkdir -p /a/final/output\necho /a/fake/file_1956_red.nc" + 
                               " /a/fake/file_1981_red.nc /a/final/output/file_1956_1981_red.txt\n")
            self.assertEqual(expected_string, the_process_unit.scheduler.job.to_str())
