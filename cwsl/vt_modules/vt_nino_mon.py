...
This module calculates a timeseries of the Nino3.4 index from
...
class IndicesNinoMonth(vistrails_module.Module):
    ...
    def __init__(self):
        ...
        super(IndicesNinoMonth, self).__init__()
        
        #Command Line Tool
        tools_base_path = configuration.cwsl_ctools_path
        self.command = '${CWSL_CTOOLS}/indices/ENSO_months.sh'
