...
This module wraps a shell script that calculates the field correlation: 
cwsl-ctools/statistics/cdo_fldcor.sh
...
class FieldCorrelation(vistrails_module.Module):
    """Field correlation.

    Wraps the cwsl-ctools/statistics/cdo_fldcor.sh script.
    ...
    command = '${CWSL_CTOOLS}/statistics/cdo_fldcor.sh'

    def __init__(self):

        super(FieldCorrelation, self).__init__()
